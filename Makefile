...
SRC = main.cpp Header_Source_File.h			# Source code files (when creating more source code files, you will need to add them here).
...
$(PROG): $(SRC)								# TARGET : DEPENDENCIES | If one of the dependencies is newer than the target, compile again
